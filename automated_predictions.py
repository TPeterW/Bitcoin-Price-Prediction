...
def main():
    ...
    # minutes before:
    minutes_before = int(sys.argv[3])

    predict(features, labels, 0.9, minutes_before)


def predict(features, labels, cutoff, minutes_before):
    ...
    #         # Can include any other data there...
